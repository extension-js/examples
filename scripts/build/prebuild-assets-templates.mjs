...
const BUILD_SCRIPT = path.join(REPO_ROOT, 'scripts', 'build-with-manifest.mjs')
...
function installDeps(exampleDir, {clean = false} = {}) {
  ...
  // Mirror scripts/build/build-all.mjs: install per-example with --ignore-workspace
...
export default async function globalSetup() {
  ...
  // List-only callers (scripts/checks/assert-spec-coverage.mjs) need Playwright to
...
// Allow standalone invocation: `node scripts/build/prebuild-assets-templates.mjs`
