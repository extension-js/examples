...
> A modern browser extension action popup example built with Extension.js and React, inspired by ChatGPT. Demonstrates how to create AI-powered action popups with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template action-chatgpt
cd <project-name>
npm install
```
