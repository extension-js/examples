...
> A modern browser extension content script example built with Extension.js using CSS Modules. Demonstrates how to create scoped styles for content scripts with clean, maintainable code.
