...
- Name: .env New Tab Example
- Summary: Replaces your new tab page with the extension's environment values.
...
Replaces your new tab page with the extension's environment values.

### Permissions justification

This template requests no permissions and no host access, so there
is nothing to justify. If you add a permission, add a specific,
...
- 1.0.0 (unreleased): initial version from the new-env template.
