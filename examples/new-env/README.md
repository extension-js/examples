...
> A modern browser extension new tab page example built with Extension.js and TypeScript using environment variables. Demonstrates how to use environment configuration in new tab pages with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template new-env
cd <project-name>
npm install
```
