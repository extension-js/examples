...
**How it works**: The manifest overrides the new-tab page and loads a Preact + TypeScript entry bundled from `src/newtab/`.

## Try it locally

```bash
npx extension@latest create my-newtab-preact --template newtab-preact
cd my-newtab-preact
npm install
npm run dev
```
