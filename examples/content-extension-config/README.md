...
> A modern browser extension content script example built with Extension.js and React using custom configuration. Demonstrates how to create configurable content scripts with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template content-extension-config
cd <project-name>
npm install
```
