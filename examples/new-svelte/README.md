...
> A modern browser extension new tab page example built with Extension.js and Svelte. Demonstrates how to create interactive new tab pages using Svelte components with clean, maintainable code.
