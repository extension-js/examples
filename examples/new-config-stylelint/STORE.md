...
- Name: Stylelint Config New Tab Example
- Summary: New tab page example with Stylelint configured.
...
New tab page example with Stylelint configured.
...
- 1.0.0 (unreleased): initial version from the new-config-stylelint template.
