...
- Name: ImageMagick New Tab Example
- Summary: Replaces your new tab page with a Vue page that blurs, rotates, and charcoals a picture using ImageMagick.
...
- 1.0.0 (unreleased): initial version from the newtab-vue-imagemagick template.
