  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        {
          path: 'blur',
          component: () => import('../views/classes/MagickImage/BlurView.vue')
        },
        {
          path: 'charcoal',
          component: () =>
        ...
        },
        {
          path: 'liquidRescale',
          component: () =>
            import('../views/classes/MagickImage/LiquidRescaleView.vue')
        },
        {
          path: 'rotate',
          component: () => import('../views/classes/MagickImage/RotateView.vue')
        }
      ]
    },
    {
