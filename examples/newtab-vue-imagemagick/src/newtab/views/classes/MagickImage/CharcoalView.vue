...
<template>
  <CodeSample
    code="import { ImageMagick } from '@imagemagick/magick-wasm/image-magick'
...
ImageMagick.readFromCanvas(canvas, (image) => {
  ...
  <div class="arguments">
    <label>Radius:</label><input type="number" v-model.number="radius" /><br />
    <label>Sigma:</label><input type="number" v-model.number="sigma" /><br />
  </div>
