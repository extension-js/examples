...
> A modern browser extension new tab page example built with Extension.js, React, and Tailwind CSS. Demonstrates how to create styled new tab pages using Tailwind CSS with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template new-tailwind
cd <project-name>
npm install
```
