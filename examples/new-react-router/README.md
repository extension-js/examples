...
> A modern browser extension new tab page example built with Extension.js, React, and React Router. Demonstrates how to create multi-page new tab pages using React Router with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template new-react-router
cd <project-name>
npm install
```
