...
- Name: React Sidebar Example
- Summary: React sidebar example using shadcn/ui components.
...
React sidebar example using shadcn/ui components.
...
- 1.0.0 (unreleased): initial version from the sidebar-shadcn template.
