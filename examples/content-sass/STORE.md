...
- Summary: Injects a small styled badge into web pages, with an options page that moves it to either edge.
...
Injects a small styled badge into web pages, with an options page that moves it to either edge.
