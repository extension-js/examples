...
export default function initial() {
  ...
  // The pill stays plain CSS: antd renders its styles into the document head
  // of the page it mounts in, which never reaches this shadow root.
  const mountingPoint = createRoot(shadowRoot)
