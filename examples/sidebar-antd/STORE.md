...
- Name: Ant Design Sidebar Example
- Summary: Adds a sidebar panel built with Ant Design.
...
Adds a sidebar panel built with Ant Design.
...
- 1.0.0 (unreleased): initial version from the sidebar-antd template.
