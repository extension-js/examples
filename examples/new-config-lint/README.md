...
> A modern browser extension new tab page example built with Extension.js and comprehensive linting tools. Demonstrates how to set up ESLint, Prettier, and Stylelint for new tab pages with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template new-config-lint
cd <project-name>
npm install
```
