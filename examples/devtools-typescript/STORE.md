...
- Name: TypeScript Devtools Panel Example
- Summary: Adds a devtools panel to the browser that reads the inspected page.
...
- 1.0.0 (unreleased): initial version from the devtools-typescript template.
