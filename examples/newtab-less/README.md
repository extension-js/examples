...
**How it works**: The manifest overrides the new-tab page and loads a JavaScript entry bundled from `src/newtab/`. Styles flow through Less.

## Try it locally

```bash
npx extension@latest create my-newtab-less --template newtab-less
cd my-newtab-less
npm install
npm run dev
```
