...
- Name: Tesseract OCR New Tab Example
- Summary: Replaces your new tab page with a page that reads text from an image using Tesseract.
...
- 1.0.0 (unreleased): initial version from the newtab-typescript-tesseract template.
