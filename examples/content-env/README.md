...
> A modern browser extension content script example built with Extension.js and TypeScript using environment variables. Demonstrates how to use environment configuration in content scripts with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template content-env
cd <project-name>
npm install
```
