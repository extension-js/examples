...
- Summary: Injects a small styled badge into web pages, with a Less modules options page that moves it to either edge.
...
Injects a small styled badge into web pages, with a Less modules options page that moves it to either edge.
...
click Open options on the badge and tick the setting to watch the badge
move to the left edge. The build is bundled, so AMO
