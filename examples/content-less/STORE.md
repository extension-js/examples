...
- Summary: Injects a small styled badge into web pages, with a Less options page that moves it to either edge.
...
Injects a small styled badge into web pages, with a Less options page that moves it to either edge.
