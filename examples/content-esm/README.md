...
> A modern browser extension content script example built with Extension.js using ES modules. Demonstrates how to use modern JavaScript modules in content scripts with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template content-esm
cd <project-name>
npm install
```
