...
**How it works**: The manifest overrides the new-tab page and loads a JavaScript entry bundled from `src/newtab/`.

## Try it locally

```bash
npx extension@latest create my-newtab --template newtab
cd my-newtab
npm install
npm run dev
```
