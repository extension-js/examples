...
> A modern browser extension new tab page example built with Extension.js using Less CSS. Demonstrates how to create custom new tab pages with Less preprocessing and clean, maintainable code.
