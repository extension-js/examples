...
- Name: Less New Tab Example
- Summary: New tab page example styled with Less.
...
New tab page example styled with Less.
...
- 1.0.0 (unreleased): initial version from the new-less template.
