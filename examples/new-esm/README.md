...
> A modern browser extension new tab page example built with Extension.js using ES modules. Demonstrates how to create custom new tab pages with modern JavaScript modules and clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template new-esm
cd <project-name>
npm install
```
