...
- Name: Zstandard New Tab Example
- Summary: Replaces your new tab page with a page that compresses and decompresses text using Zstandard.
...
- 1.0.0 (unreleased): initial version from the newtab-typescript-zstd template.
