...
export default function initial() {
  ...
  rootDiv.setAttribute('data-extension-root', 'bottom-right')
  ...
  contentDiv.className = 'content_script content_script_bottom_right'
  ...
  title.textContent = 'Content Template #4'
