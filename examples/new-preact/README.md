...
> A modern browser extension new tab page example built with Extension.js and Preact. Demonstrates how to create lightweight interactive new tab pages using Preact components with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template new-preact
cd <project-name>
npm install
```
