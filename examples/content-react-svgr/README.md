...
> A modern browser extension content script example built with Extension.js and React using SVGR. Demonstrates how to create interactive content scripts with SVG components using clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template content-react-svgr
cd <project-name>
npm install
```
