...
- Summary: Injects a badge with a custom font into web pages, with an options page that turns it off.
...
Injects a badge with a custom font into web pages, with an options page that turns it off.
