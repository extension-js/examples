...
- Name: Vue Devtools Panel Example
- Summary: Adds a devtools panel built with Vue that reads the inspected page.
...
- 1.0.0 (unreleased): initial version from the devtools-vue template.
