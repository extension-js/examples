...
> A modern browser extension new tab page example built with Extension.js and ESLint. Demonstrates how to set up code linting for new tab pages with clean, maintainable code.
