...
- Name: ESLint Config New Tab Example
- Summary: New tab page example with ESLint configured.
...
New tab page example with ESLint configured.
...
- 1.0.0 (unreleased): initial version from the new-config-eslint template.
