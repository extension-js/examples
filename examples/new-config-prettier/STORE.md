...
- Name: Prettier Config New Tab Example
- Summary: New tab page example with Prettier configured.
...
New tab page example with Prettier configured.
...
- 1.0.0 (unreleased): initial version from the new-config-prettier template.
