...
> A modern browser extension new tab page example built with Extension.js and Prettier. Demonstrates how to set up code formatting for new tab pages with clean, maintainable code.
