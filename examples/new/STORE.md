...
- Name: JavaScript New Tab Example
- Summary: New tab page example using plain JavaScript.
...
New tab page example using plain JavaScript.
...
- 1.0.0 (unreleased): initial version from the new template.
