...
- Name: Sass New Tab Example
- Summary: New tab page example styled with Sass.
...
New tab page example styled with Sass.
...
- 1.0.0 (unreleased): initial version from the new-sass template.
