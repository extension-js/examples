...
- Name: Vue New Tab Example
- Summary: New tab page example rendered with Vue.
...
New tab page example rendered with Vue.
...
- 1.0.0 (unreleased): initial version from the new-vue template.
