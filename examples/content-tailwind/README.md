...
> A modern browser extension content script example built with Extension.js and Tailwind CSS. Demonstrates how to create styled content scripts using Tailwind CSS with clean, maintainable code.
...
```bash
npx extension@latest create <project-name> --template content-tailwind
cd <project-name>
npm install
```
