...
- Name: React Devtools Panel Example
- Summary: Adds a React devtools panel to the browser that reads the inspected page.
...
Adds a React devtools panel to the browser that reads the inspected
page.
...
- 1.0.0 (unreleased): initial version from the devtools-react template.
