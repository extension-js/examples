...
> A modern browser extension new tab page example built with Extension.js using ES modules and environment variables. Demonstrates how to use modern JavaScript modules with environment configuration in new tab pages.
...
```bash
npx extension@latest create <project-name> --template new-env-esm
cd <project-name>
npm install
```
